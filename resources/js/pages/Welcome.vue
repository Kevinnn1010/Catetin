...
<template>
      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="/" class="flex items-center justify-between mr-4">
            <img
              src="/images/it-blue.svg"
              class="mr-3 h-8"
              alt="Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Catetin</span>
          </a>
  ...
  >
    ...
    <span class="flex-1 ml-3 text-left whitespace-nowrap">Finansial</span>

    <!-- Arrow toggle -->
    <svg
      aria-hidden="true"
      class="w-6 h-6 transition-transform"
      :class="{'rotate-180': isDropdownOpen('finance')}"
      fill="currentColor"
      viewBox="0 0 20 20"
    >
      <path
  ...
  <ul v-show="isDropdownOpen('finance')" class="py-2 space-y-2">
    <li>
      <a
        href="/finance_dashboard"
        class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
      >
        Dashboard
      </a>
    </li>
  ...
  >
    ...
    <svg
      aria-hidden="true"
      class="w-6 h-6 transition-transform"
      :class="{'rotate-180': isDropdownOpen('kesehatan')}"
      fill="currentColor"
      viewBox="0 0 20 20"
    >
      <path
    ...
    <li>
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Pengingat</span>
              <span class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-blue-800 bg-blue-100 dark:bg-blue-200">
  4
</span>
            </a>
          </li>
