        ...
        <ul class="space-y-2">
          ...
          <li>
            ...
            <button type="button"
              ...
              <svg aria-hidden="true" class="w-6 h-6 transition-transform"
                :class="{ 'rotate-180': isDropdownOpen('finance') }" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd"
          ...
          <li>
            ...
            <button type="button"
              ...
              <!-- Arrow toggle -->
              <svg aria-hidden="true" class="w-6 h-6 transition-transform"
                :class="{ 'rotate-180': isDropdownOpen('kesehatan') }" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                  clip-rule="evenodd"></path>
              </svg>
        ...
        <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          <li>
            <a href="#"
              ...
              <svg aria-hidden="true"
                class="w-6 h-6 text-gray-600 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white dark:text-white"
                width="24" height="24" fill="currentColor" viewBox="0 0 19 19" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                  d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z"
                  clip-rule="evenodd"></path>
              </svg>
